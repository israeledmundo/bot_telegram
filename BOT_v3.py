'''
Este está funcionando mas salvando na pasta Saved
'''
...
TELEGRAM_ID = 778392785  # Seu próprio ID do Telegram
CHANNEL_USERNAME = ['@gatunopromos', '@promo_imperdivel']  # Username do canal que você quer monitorar

# Lista de palavras-chave a serem monitoradas
PALAVRAS_CHAVE = ["POR", "por", "Por:"]
